...
def find_nuts2_by_name(name: str) -> tuple[str, str]:
    """Find the NUTS2 code that best matches a city or region name.
    ...
    ----------
    name : str
        Free-text city or region name, e.g. ``"Campania"``, ``"Andalucía"``, or
        ``"Ile-de-France"``.

    Returns
    -------
    tuple[str, str]
        The NUTS2 code and display name for the best-matching region,
        e.g. ``("ITF3", "Campania")``.
